...
```shell
curl -fsSL https://github.com/gremlin/selinux-policies/releases/download/v0.0.1/selinux-policies-v0.0.1.tar.gz -o selinux-policies-v0.0.1.tar.gz
tar xzf selinux-policies-v0.0.1.tar.gz
sudo semodule -i selinux-policies-v0.0.1/gremlin-openshift3.cil
```
